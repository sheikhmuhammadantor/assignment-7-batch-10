  ...
  return (
    <div className="flex flex-wrap justify-between mt-16">
      ...
      <div className="flex flex-wrap border rounded-lg">
        ...
        <button onClick={() => handelSelected(true)} id="selected" className={`btn py-2 px-5 rounded-r-lg rounded-l-none border-0 text-base ${selected ? 'bg-[#d9ee27] hover:bg-[#d9ee27]' : 'bg-transparent hover:bg-transparent'}`}>Selected(0)</button>
      </div>
    </div>
  )
}
